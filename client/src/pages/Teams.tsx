...
const teamMembers = [
  ...
  },
  {
    ...
    email: "odong.gilbert@mshindi.com",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="inline-block">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-foreground" data-testid="text-teams-heading">
                Our Team
              </h1>
            </div>
            <p className="mt-6 text-lg text-muted-foreground max-w-3xl mx-auto">
              Meet the dedicated professionals behind Mshindi Enterprises Limited
            </p>
          </div>
